...
function resetGame() {
    ...
    // Turunkan probabilitas setiap kali retry dan log probabilitas
    for (let i = 0; i < rounds.length; i++) {
        rounds[i].prob = Math.max(0, rounds[i].prob - 0.1);
        console.log(`Round ${i + 1} Probabilitas: ${rounds[i].prob}`);
    }
}
